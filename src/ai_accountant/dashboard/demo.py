...
TEST_DATASET_LABEL = "2025 US taxpayer story"
TEST_SIGNATURES = {
    "exchange_sol": "G" * 88,
    "samo_large": "H" * 88,
    "samo_small": "J" * 88,
...
def build_demo_dataframe() -> pd.DataFrame:
    ...
    rows = [
        ...
        _row(
            ...
            source="MAGIC_EDEN",
            description="Sold an NFT on Magic Eden and received SOL.",
            fee_sol="0.00021",
            native_in_sol="3.2",
            native_out_sol="0",
            status="succeeded",
            ...
            tag_assets="Solana NFT",
            tag_amount_display="Solana NFT for 3.2 SOL",
            tag_confidence=0.88,
        ),
        _row(
            signature="7" * 88,
        ...
        _row(
            ...
            transaction_type="SWAP",
            source="JUPITER",
            description="Tax-loss harvesting candidate: swapped SOL into SAMO before a year-end drawdown.",
            fee_sol="0.00019",
            native_in_sol="0",
            native_out_sol="6.4",
            status="succeeded",
...
def build_test_dataframe() -> pd.DataFrame:
    ...
    rows = [
        _row(
            ...
            transaction_type="TRANSFER",
            source="COINBASE",
            description="Bought SOL on Coinbase and moved it to the US taxpayer wallet.",
            fee_sol="0",
            native_in_sol="220",
            native_out_sol="0",
            status="succeeded",
        ...
        _row(
            ...
            transaction_type="SWAP",
            source="JUPITER",
            description="Second SAMO acquisition lot for the tax optimization review.",
            fee_sol="0.0002",
            native_in_sol="0",
            native_out_sol="42",
            status="succeeded",
        ...
        _row(
            ...
            transaction_type="STAKE",
            source="STAKE_PROGRAM",
            description="Staked SOL; pre-reviewed as a non-taxable staking deposit.",
            fee_sol="0.000005",
            native_in_sol="0",
            native_out_sol="20",
            status="succeeded",
        ...
        _row(
            ...
            transaction_type="NFT_SALE",
            source="MAGIC_EDEN",
            description="Sold the NFT on Magic Eden; prepared for capital gain review.",
            fee_sol="0.00024",
            native_in_sol="4",
            native_out_sol="0",
            status="succeeded",
            ...
            tag_protocol="Magic Eden",
            tag_assets="Solana NFT",
            tag_amount_display="Solana NFT for 4 SOL",
            tag_confidence=0.87,
        ...
        _row(
            ...
            transaction_type="TRANSFER",
            source="UNKNOWN",
            description="Incoming transfer that the client confirms as their own wallet during the review.",
            fee_sol="0",
            native_in_sol="14",
            native_out_sol="0",
            status="succeeded",
...
def build_test_secondary_dataframe() -> pd.DataFrame:
    ...
    rows = [
        _row(
            ...
            transaction_type="TRANSFER",
            source="SYSTEM",
            description="Received SOL from the primary wallet owned by the same taxpayer.",
            fee_sol="0.000005",
            native_in_sol="25",
            native_out_sol="0",
            status="succeeded",
